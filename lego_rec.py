# with help from: https://www.kaggle.com/pacogarciam3/lego-set-object-recognition-example
# using the dataset: https://www.kaggle.com/pacogarciam3/lego-brick-sorting-image-recognition
...
# We will be previewing images along the way, so lets create a function
